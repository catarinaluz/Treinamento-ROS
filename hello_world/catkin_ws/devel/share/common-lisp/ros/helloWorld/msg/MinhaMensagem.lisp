...
(cl:defmethod cl:initialize-instance :after ((m <MinhaMensagem>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MinhaMensagem)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name helloWorld-msg:<MinhaMensagem> is deprecated: use helloWorld-msg:MinhaMensagem instead.")))

(cl:ensure-generic-function 'primeiroInteiro-val :lambda-list '(m))
(cl:defmethod primeiroInteiro-val ((m <MinhaMensagem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:primeiroInteiro-val is deprecated.  Use helloWorld-msg:primeiroInteiro instead.")
  (primeiroInteiro m))

(cl:ensure-generic-function 'segundoInteiro-val :lambda-list '(m))
(cl:defmethod segundoInteiro-val ((m <MinhaMensagem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:segundoInteiro-val is deprecated.  Use helloWorld-msg:segundoInteiro instead.")
  (segundoInteiro m))

(cl:ensure-generic-function 'texto-val :lambda-list '(m))
(cl:defmethod texto-val ((m <MinhaMensagem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader helloWorld-msg:texto-val is deprecated.  Use helloWorld-msg:texto instead.")
  (texto m))
